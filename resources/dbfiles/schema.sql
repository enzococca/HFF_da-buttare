...
CREATE TABLE public.coastline(
    id int NOT NULL,
    the_geom public.geometry(MultiLineString,-1),
...
(
	...
	assessment_investigator_actor text COLLATE pg_catalog."default",
	investigator_role_type text COLLATE pg_catalog."default",
	assessment_activity_type text COLLATE pg_catalog."default",
	assessment_activity_date text COLLATE pg_catalog."default",
	ge_assessment text COLLATE pg_catalog."default",
	ge_imagery_acquisition_date text COLLATE pg_catalog."default",
	information_resource_used text COLLATE pg_catalog."default",
	information_resource_acquisition_date text COLLATE pg_catalog."default",
	resource_name text COLLATE pg_catalog."default",
	name_type text COLLATE pg_catalog."default",
	heritage_place_type text COLLATE pg_catalog."default",
	general_description_type text COLLATE pg_catalog."default",
	general_description text COLLATE pg_catalog."default",
	heritage_place_function text COLLATE pg_catalog."default",
	heritage_place_function_certainty text COLLATE pg_catalog."default",
	designation text COLLATE pg_catalog."default",
	designation_from_date text COLLATE pg_catalog."default",
	designation_to_date text COLLATE pg_catalog."default",
	geometric_place_expression text COLLATE pg_catalog."default",
	geometry_qualifier text COLLATE pg_catalog."default",
	site_location_certainty text COLLATE pg_catalog."default",
	geometry_extent_certainty text COLLATE pg_catalog."default",
	site_overall_shape_type text COLLATE pg_catalog."default",
	grid_id text COLLATE pg_catalog."default",
	country_type text COLLATE pg_catalog."default",
	cadastral_reference text COLLATE pg_catalog."default",
	resource_orientation text COLLATE pg_catalog."default",
	address text COLLATE pg_catalog."default",
	address_type text COLLATE pg_catalog."default",
	administrative_subdivision text COLLATE pg_catalog."default",
	administrative_subdivision_type text COLLATE pg_catalog."default",
	overall_archaeological_certainty_value text COLLATE pg_catalog."default",
	overall_site_morphology_type text COLLATE pg_catalog."default",
	cultural_period_type text COLLATE pg_catalog."default",
	cultural_period_certainty text COLLATE pg_catalog."default",
	cultural_subperiod_type text COLLATE pg_catalog."default",
	cultural_subperiod_certainty text COLLATE pg_catalog."default",
	date_inference_making_actor text COLLATE pg_catalog."default",
	archaeological_date_from text COLLATE pg_catalog."default",
	archaeological_date_to text COLLATE pg_catalog."default",
	bp_date_from text COLLATE pg_catalog."default",
	bp_date_to text COLLATE pg_catalog."default",
	ah_date_from text COLLATE pg_catalog."default",
	ah_date_to text COLLATE pg_catalog."default",
	sh_date_from text COLLATE pg_catalog."default",
	sh_date_to text COLLATE pg_catalog."default",
	site_feature_form_type text COLLATE pg_catalog."default",
	site_feature_form_type_certainty text COLLATE pg_catalog."default",
	site_feature_shape_type text COLLATE pg_catalog."default",
	site_feature_arrangement_type text COLLATE pg_catalog."default",
	site_feature_number_type text COLLATE pg_catalog."default",
	site_feature_interpretation_type text COLLATE pg_catalog."default",
	site_feature_interpretation_number text COLLATE pg_catalog."default",
	site_feature_interpretation_certainty text COLLATE pg_catalog."default",
	built_component_related_resource text COLLATE pg_catalog."default",
	hp_related_resource text COLLATE pg_catalog."default",
	material_class text COLLATE pg_catalog."default",
	material_type text COLLATE pg_catalog."default",
	construction_technique text COLLATE pg_catalog."default",
	measurement_number text COLLATE pg_catalog."default",
	measurement_unit text COLLATE pg_catalog."default",
	dimension_type text COLLATE pg_catalog."default",
	measurement_source_type text COLLATE pg_catalog."default",
	related_geoarch_palaeo text COLLATE pg_catalog."default",
	overall_condition_state text COLLATE pg_catalog."default",
	damage_extent_type text COLLATE pg_catalog."default",
	disturbance_cause_category_type text COLLATE pg_catalog."default",
	disturbance_cause_type text COLLATE pg_catalog."default",
	disturbance_cause_certainty text COLLATE pg_catalog."default",
	disturbance_date_from text COLLATE pg_catalog."default",
	disturbance_date_to text COLLATE pg_catalog."default",
	disturbance_date_occurred_before text COLLATE pg_catalog."default",
	disturbance_date_occurred_on text COLLATE pg_catalog."default",
	disturbance_cause_assignment_assessor_name text COLLATE pg_catalog."default",
	effect_type text COLLATE pg_catalog."default",
	effect_certainty text COLLATE pg_catalog."default",
	threat_category text COLLATE pg_catalog."default",
	threat_type text COLLATE pg_catalog."default",
	threat_probability text COLLATE pg_catalog."default",
	threat_inference_making_assessor_name text COLLATE pg_catalog."default",
	intervention_activity_type text COLLATE pg_catalog."default",
	recommendation_type text COLLATE pg_catalog."default",
	priority_type text COLLATE pg_catalog."default",
	related_detailed_condition_resource text COLLATE pg_catalog."default",
	topography_type text COLLATE pg_catalog."default",
	land_cover_type text COLLATE pg_catalog."default",
	land_cover_assessment_date text COLLATE pg_catalog."default",
	surficial_geology_type text COLLATE pg_catalog."default",
	depositional_process text COLLATE pg_catalog."default",
	bedrock_geology text COLLATE pg_catalog."default",
	fetch_type text COLLATE pg_catalog."default",
	wave_climate text COLLATE pg_catalog."default",
	tidal_energy text COLLATE pg_catalog."default",
	minimum_depth_max_elevation text COLLATE pg_catalog."default",
	maximum_depth_min_elevation text COLLATE pg_catalog."default",
	datum_type text COLLATE pg_catalog."default",
	datum_description_epsg_code text COLLATE pg_catalog."default",
	restricted_access_record_designation text COLLATE pg_catalog."default",
...
(
    gid integer NOT NULL DEFAULT nextval('site_line_id_seq'::regclass),
    ...
    CONSTRAINT site_line_pkey PRIMARY KEY (gid)
)
WITH (
    OIDS = FALSE
)
...
(
    gid integer NOT NULL DEFAULT nextval('site_point_id_seq'::regclass),
	...
	coord character varying COLLATE pg_catalog."default",
    CONSTRAINT site_point_pkey PRIMARY KEY (gid)
)
WITH (
    OIDS = FALSE
)
...
SELECT AddGeometryColumn('public','grid_eamena_lebanon','the_geom',-1,'MULTIPOLYGON',2);
